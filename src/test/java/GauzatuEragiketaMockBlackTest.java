...
static DataAccess sut;
	...
	//sut.createRide:  The User is null. The test must return false. If  an Exception is returned the createRide method is not well implemented.
			...
			@Test
			//sut.createRide:  The User is not in the db. The test must return false. If  an Exception is returned the createRide method is not well implemented.
				public void test2() {
					boolean ride;
					try {
			...
			@Test
			//sut.createRide:  The User is in the DB but he has put minus money. The test must return false. If  an Exception is returned the createRide method is not well implemented.
				public void test3() {
					boolean ride;
					try {
			...
			@Test
			//sut.createRide:  The User is in the DB and has taken money but he hasn't enough money. The test must return true. If  an Exception is returned the createRide method is not well implemented.
			public void test6() {
				boolean ride;
				try {
